<div class="pqrs index">
	<h2><?php echo __('Listado Maestro PQRs'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver'), array('action' => 'view', $pqr['Pqr']['id'])); ?>
			<?php echo $this->Html->link(__('Responder'), array('action' => 'reply', $pqr['Pqr']['id'])); ?>
