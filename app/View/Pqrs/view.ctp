<div class="pqrs view">
<h2><?php echo __('Detalles de la PQR con radicado '.$pqr['Pqr']['id_located']); ?></h2>
	<dl>
...
<div class="actions">
	<h3><?php echo __('Accioness'); ?></h3>
	<ul>
		<li><?php echo $this->Html->link(__('Listado Maestro PQRs'), array('action' => 'index')); ?> </li>
                <li><?php echo $this->Html->link(__('Responder PQR'), array('controller' => 'pqrs', 'action' => 'reply', $pqr['Pqr']['id'])); ?> </li>
	</ul>
</div>
